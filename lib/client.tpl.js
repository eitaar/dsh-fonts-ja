...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"font.weightHint": "字重说明：400 常规 · 500 中等 · 600 半粗 · 700 粗体，请选择与字体文件实际粗细一致的字重（选错只会让浏览器自动合成粗细）",
		...
		const en = {
			...
			"font.weightHint": "Weights: 400 Regular · 500 Medium · 600 Semibold · 700 Bold — pick the weight your font file actually is (a wrong pick only makes the browser synthesize the weight)",
