...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function FontPreview({ uiStack, chatStack, codeStack, t }) {
			const rows = [
				{ role: "ui", label: t("font.preview.ui"), value: "設定 Settings", stack: uiStack },
				{ role: "chat", label: t("font.preview.chat"), value: "日本語を表示 123", stack: chatStack },
				{ role: "code", label: t("font.preview.code"), value: 'const 日本語', stack: codeStack }
			];
