						...
						: faces.map((face) => (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, react_jsx_runtime.jsx)("span", {
										...
										children: `${face.family} (${face.weight}) — ${face.src[0]}`
									}),
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("input", {
								...
								style: { ...styles.input, ...styles.inputFamily }
							}),
							(0, react_jsx_runtime.jsx)("input", {
								value: url,
							...
							(0, react_jsx_runtime.jsxs)("select", {
								...
								style: styles.input,
								children: [
									(0, react_jsx_runtime.jsx)("option", { value: "400", children: "400" }),
									(0, react_jsx_runtime.jsx)("option", { value: "500", children: "500" }),
									(0, react_jsx_runtime.jsx)("option", { value: "600", children: "600" }),
									(0, react_jsx_runtime.jsx)("option", { value: "700", children: "700" })
								]
							}),
							(0, react_jsx_runtime.jsx)("button", {
								type: "button",
