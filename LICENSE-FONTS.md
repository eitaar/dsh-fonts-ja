...
The source code and plugin modifications are licensed under the MIT License in
LICENSE. Bundled webfonts under data/fonts/ are separately licensed under the
SIL Open Font License 1.1. The complete license text for each font ships with
that font as data/fonts/LICENSE-*.txt.
